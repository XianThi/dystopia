...
{{content()}}
<h1 class="page-header"><?=$lang["article"]." ".$lang["edit"];?></h1><hr />
<!-- Place this in the body of the page content -->
<div class="form-panel">
<form method="post" onsubmit="editor.post()" action="#">
<label for="title"><?=$lang["title"];?> : </label>
<input type="text" name="title" value="<?=$article_title;?>" style="width:80%;" /><br />
<label for="content"><?=$lang["content"];?> : </label>
<textarea id="elm1" name="content"><?=$article_content;?></textarea> <br />
