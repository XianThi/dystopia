...
{{ form('session/register', 'id': 'registerForm', 'class': 'form-horizontal style-form', 'onbeforesubmit': 'return false') }}
    <fieldset>
        ...
        <p><?=$lang->_("term_priv_text");?></p>
              {{ submit_button(lang["register_button"], 'class': 'btn btn-theme', 'onclick': 'return SignUp.validate();') }}
