...
<table class="table table-striped table-advance table-hover" align="center">
    <thead>
        ...
        <tr>
        <td><input type="checkbox" style="width: 15px; height:15px;" id="chkbox[]" name="chkbox[]"  value="<?php echo $notifx->id; ?>" /> <?=$i;?></td>
        <td><a href="<?php echo $this->url->get('notifications/view/') . $notifx->id; ?>" ><?=$notifx->title;?></a></td>
        <td><?=$notifx->desc;?></td>
