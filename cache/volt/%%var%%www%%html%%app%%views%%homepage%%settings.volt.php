...
<form action="<?php echo $this->url->get('citizen/upload'); ?>" method="post" enctype="multipart/form-data">
...
<form action="<?php echo $this->url->get('citizen/editbio'); ?>" method="post" enctype="multipart/form-data">
...
<form action="<?php echo $this->url->get('citizen/password'); ?>" method="post" enctype="multipart/form-data">
...
<form action="<?php echo $this->url->get('citizen/disable'); ?>" method="post" enctype="multipart/form-data">
<div class="form-group">
