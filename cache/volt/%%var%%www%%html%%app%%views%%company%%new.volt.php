...
<?php if(isset($company_price)){
  ?>
This company is <?php echo $company_price; ?> gold. Are you okey ?
<form method="POST">
...
<form id="companyform" name="companyform" method="post" action="<?php echo $this->url->get('company/new'); ?>" onbeforesubmit="return false">

<ul class="pager">
    <li class="previous pull-left">
        <?php echo $this->tag->linkTo(array('company', '&larr; Geri Dön')); ?>
    </li>
    <li class="pull-right">
        <?php echo $this->tag->submitButton(array('Save', 'class' => 'btn btn-success', 'onclick' => 'return Company.validate();')); ?>
    </li>
</ul>
