...
<?php if(isset($newspaper_price)){
  ?>
This newspaper is <?php echo $newspaper_price; ?> gold. Are you okey ?
<form method="POST">
...
<form id="newspaperform" name="newspaperform" method="post" action="<?php echo $this->url->get('newspaper/new'); ?>" onbeforesubmit="return false">

<ul class="pager">
    <li class="previous pull-left">
        <?php echo $this->tag->linkTo(array('newspaper', '&larr; ' . $lang['back'])); ?>
    </li>
    <li class="pull-right">
        <?php echo $this->tag->submitButton(array($lang['save'], 'class' => 'btn btn-success', 'onclick' => 'return Company.validate();')); ?>
    </li>
</ul>
