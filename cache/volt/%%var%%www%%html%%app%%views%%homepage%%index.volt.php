<?php echo $this->getContent(); ?>
      <script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            image: "<?php echo $this->url->get() . $image; ?>",
...
$.ajax({
type: "POST",
url: "<?php echo $this->url->get('shout/add'); ?>",
data: dataString,
cache: false,
...
$("#"+formid+" textarea[name=message]").val("");
 ...
 var refreshId = setInterval(function() {
      $("#globalshouts").load("<?php echo $this->url->get('shout/index/global'); ?>");
      $("#zoneshouts").load("<?php echo $this->url->get('shout/index/zone'); ?>");
      $("#friendshouts").load("<?php echo $this->url->get('shout/index/friends'); ?>");
      $("#latest").load("<?php echo $this->url->get('newspaper/getnews/latest'); ?>");
      $("#best").load("<?php echo $this->url->get('newspaper/getnews/best'); ?>");
   }, 2000);
return false;
...
function globalshout(){
    $("#globalshouts").html("<img src='<?php echo $this->url->get('img/loading.gif'); ?> />");
            $.get("<?php echo $this->url->get('shout/index/global'); ?>", function(data) {
            $("#globalshouts").html(data);
         
        });
}
function friendshout(){
     $("#friendshouts").html("<img src='<?php echo $this->url->get('img/loading.gif'); ?>' />");
            $.get("<?php echo $this->url->get('shout/index/friend'); ?>", function(data) {
            $("#friendshouts").html(data);
         
        });
}
function zoneshout(){
     $("#zoneshouts").html("<img src='<?php echo $this->url->get('img/loading.gif'); ?>' />");
            $.get("<?php echo $this->url->get('shout/index/zone'); ?>", function(data) {
 ...
 <div class="weather-2 pn" style="height: 100%;"><div class="weather-2-header"><p><?=$lang["wars"];?></p></div>
    <ul class="nav nav-pills" id="myTab">
      <li class="active"><a href="#zonewars" data-toggle="tab"><i class="fa fa-fighter-jet"></i><?php echo $lang['zonewars']; ?></a></li>
        <li><a href="#globalwars" data-toggle="tab"><i class="fa fa-fighter-jet"></i><?php echo $lang['globalwars']; ?></a></li>
    </ul>  </div>
</div>
 </div>
 ...
 <div class="weather-2 pn" style="height: 100%;"><div class="weather-2-header"><p><?=$lang["actions"];?></p></div>
    <ul class="nav nav-pills" id="myTab">
    <li class="active"><a href="#agenda" data-toggle="tab"><i class="fa fa-clock-o"></i> <?php echo $lang['agenda']; ?></a></li>
      <li><a href="#laws" data-toggle="tab"><i class="fa fa-clock-o"></i> <?php echo $lang['laws']; ?></a></li>
        <li><a href="#pacts" data-toggle="tab"><i class="fa fa-fighter-jet"></i> <?php echo $lang['pacts']; ?></a></li>
    </ul>  </div>
</div>
 </div>
...
<div class="weather-2 pn" style="height: 100%;"><div class="weather-2-header"><p><?=$lang["news"];?></p></div>
    <ul class="nav nav-pills nav-stacked" id="myTab">
      <li class="active"><a href="#latest" data-toggle="tab"><i class="fa fa-file-text-o"></i><?php echo $lang['latest_articles']; ?></a></li>
      <li><a href="#best" data-toggle="tab"><i class="fa fa-file-text-o"></i><?php echo $lang['best_articles']; ?></a></li>
    </ul>  </div></div>
