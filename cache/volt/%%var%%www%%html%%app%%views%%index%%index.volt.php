<div id="hello">
    ...
    <h2><?php echo $this->tag->linkTo(array('session/register', $lang['register_now'], 'class' => 'btn btn-primary btn-large btn-success')); ?> <?=$lang->_("or");?>
    <?php echo $this->tag->linkTo(array('session/index', $lang['login'], 'class' => 'btn btn-primary btn-large btn-success')); ?></h2>
	    		</div><!-- /col-lg-8 -->
	    	</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /hello -->  
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5 centered">
					<img src="<?php echo $this->url->get('img/world.png'); ?>" alt="">
				</div>
	...
	<div class="container">
		<div class="row centered mt grid">
			...
			<div class="mt"></div>
			<div class="col-lg-4">
				<a href="#"><img src="<?php echo $this->url->get('img/01.jpg'); ?>" alt=""></a>
			</div>
			<div class="col-lg-4">
				<a href="#"><img src="<?php echo $this->url->get('img/02.jpg'); ?>" alt=""></a>
			</div>
			<div class="col-lg-4">
				<a href="#"><img src="<?php echo $this->url->get('img/03.jpg'); ?>" alt=""></a>
			</div>
		</div>
		...
		<div class="row centered mt grid">
			<div class="mt"></div>		
			<div class="col-lg-4">
				<a href="#"><img src="<?php echo $this->url->get('img/04.jpg'); ?>" alt=""></a>
			</div>
			<div class="col-lg-4">
				<a href="#"><img src="<?php echo $this->url->get('img/05.jpg'); ?>" alt=""></a>
			</div>
			<div class="col-lg-4">
				<a href="#"><img src="<?php echo $this->url->get('img/06.jpg'); ?>" alt=""></a>
			</div>
		</div>
